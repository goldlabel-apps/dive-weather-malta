...
// import FlickrIcon from "../../Flash/MovieClips/FlickrIcon";
// import InstagramIcon from "../../Flash/MovieClips/InstagramIcon";
// import ContentfulIcon from "../../Flash/MovieClips/IconContentful";
...
export default function Icon(props: any) {
  ...
  switch (icon) {
    ...
    // case "contentful":
    //   iconFragment = <div style={{width:24, height:24}}><ContentfulIcon /></div>
    //   break
    ...
    case "you":
      ...
      // case "flickr":
      //   iconFragment = <div style={{width:24, height:24}}><FlickrIcon /></div>
      //   break

      // case "instagram":
      //   iconFragment = <div style={{width:24, height:24}}><InstagramIcon /></div>
      //   break
